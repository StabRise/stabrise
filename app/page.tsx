      ...
      <SectionContainer>
        <section>
          ...
          <p className="mx-auto mt-6 max-w-5xl px-6 pb-6 text-center text-lg text-gray-600">
            ...
            your business. Stay compliant with <strong>HIPAA</strong>, <strong>GDPR</strong>, and other regulations while improving
            efficiency. Powered by <strong>Spark</strong> and <strong>AI</strong>, we make it easy to scale your document processing
