...
const whyChooseUs = [
  {
    ...
    icon: <FaFileInvoice size={24} className="text-primary-500" />
  },
  {
    title: "Security",
    ...
    icon: <FaLock size={24} className="text-primary-500" />
  },
  {
    title: "Compliance",
    ...
    icon: <FaClipboardList size={24} className="text-primary-500" />
  },
  {
    title: "Scalability",
    ...
    icon: <FaCloud size={24} className="text-primary-500" />
  },
  {
    ...
    icon: <FaFilePdf size={24} className="text-primary-500" />
  },
  {
