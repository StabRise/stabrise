...
>
  <div
  >
    <span class="inline">This project now works on Databricks. Check out the </span>
    <a
      href="https://github.com/StabRise/spark-pdf/blob/main/examples/PdfDataSourceDatabricks.ipynb"
      target="_blank"
      rel="noopener noreferrer"
      class="inline">Databricks example</a>
    <span class="inline"> for more details.</span>
  </div>
</Note>
...
>
  <div>
    <span class="inline">Compatible with </span>
    <a
      href="/projects/scale-dp"
      target="_blank"
      rel="noopener noreferrer"
      class="inline">ScaleDP, an Open-Source Library</a>
    <span class="inline">  for Processing Documents using AI/ML in Apache Spark.</span>
  </div>
</Note>
>
