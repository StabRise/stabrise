...
const usageCases = [
  {
    ...
    icon: <FaFileInvoice size={24} className="text-secondary-500" />
  },
  {
    ...
    icon: <FaStethoscope size={24} className="text-primary-500" />
  },
  {
  ...
  },
  {
    ...
    icon: <FaRegFileAlt size={24} className="text-primary-500" />
  },
  {
    ...
    icon: <FaCogs size={24} className="text-primary-500" />
  }
];
